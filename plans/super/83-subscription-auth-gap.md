...
- **DEC-016** — **Option B deferred to follow-up #86.** The hybrid route: ship Option A now (this PR) and file a tracked follow-up for the `claude -p` subprocess transport that would restore subscription support for the five LLM-mediated commands.
